...
describe('calculator functionality', function() {
  ...
  it('should display the result of the arithmetical operations', function(){
    running_total = element(by.css('#running_total'))
    element(by.css('#number2')).click();
  ...
  it('should be able to display very large numbers', function(){
    ...
    element(by.css('#number0')).click();
    element(by.css('#number0')).click();
    expect(running_total.getAttribute('value')).to.eventually.equal('700000000')
  })

  it('should not be able to divide by zero and return error message', function(){
    running_total = element(by.css('#running_total'))
    element(by.css('#number7')).click();
    element(by.css('#operator_divide')).click();
    element(by.css('#number0')).click();
